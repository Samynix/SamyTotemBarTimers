SamyTotemBarTimersBuffTotemButton = {}

function SamyTotemBarTimersBuffTotemButton:Create(parentFrame, totemInfo, totemListId)
    local templates = "ActionButtonTemplate"
    local instance = SamyTotemBarTimersButtonBase:Create(parentFrame,
        "SamyTotemBarTimers" .. totemListId .. "BuffTotemButton",
        templates)
